(() => {
  'use strict';
  GHTKTools.register('autoClick', {
    name: "Auto Clicker",
    description: "Phím tắt, macro và click tự động",
    type: 'toggle',
    start() {
      (() => {
          'use strict';
    ...
    stop() {
      document.querySelector('#shortcut-console')?.remove(); document.querySelector('#sc-toggle')?.remove(); document.querySelectorAll('.sc-target-wrapper,.sc-click-ripple,.sc-modal,#sc-global-rec-overlay,#sc-global-rec-banner').forEach(el=>el.remove());
    }
  });
})();
